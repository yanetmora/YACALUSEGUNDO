...
public class DetallePersonajeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista=inflater.inflate(R.layout.activity_fragment_grammar, container, false);
        ...
        GrammarVoActivity miPersonaje=null;
        if (objetoPersonaje != null) {
            miPersonaje= (GrammarVoActivity) objetoPersonaje.getSerializable("objeto");
    ...
    public void asignarInformacion(GrammarVoActivity miPersonaje) {
